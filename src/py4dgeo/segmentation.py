            ...
            for start_idx in changepoints:
                ...
                for target_idx in range(start_idx + 1, timeseries.shape[0]):
                    ...
                    if previous_volume > volume:
                        lod_val = self.analysis.uncertainties["lodetection"][i, target_idx] 
                        ...
                        if (target_idx - start_idx >= self.minperiod) and (
                            ...
                            >= lod_val # Previously height_threshold, adapted to compare with level of detection for each object
                        ):
